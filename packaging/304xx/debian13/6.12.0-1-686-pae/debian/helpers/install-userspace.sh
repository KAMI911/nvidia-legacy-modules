...
NVDIR="$LIBDIR/nvidia/legacy-304xx"

install -d "$LIBDIR" "$NVDIR" "$DEST/usr/bin" "$DEST/usr/share/doc/nvidia-legacy-304xx-driver-libs" \
...
# --- license / docs ---
copy "LICENSE" "$DEST/usr/share/doc/nvidia-legacy-304xx-driver-libs/LICENSE" 0644
