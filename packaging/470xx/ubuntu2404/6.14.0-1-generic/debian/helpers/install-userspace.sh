...
NVDIR="$LIBDIR/nvidia/legacy-470xx"

install -d "$LIBDIR" "$NVDIR" "$DEST/usr/bin" "$DEST/usr/share/doc/nvidia-legacy-470xx-driver-libs" \
...
# --- license / docs ---
copy "LICENSE" "$DEST/usr/share/doc/nvidia-legacy-470xx-driver-libs/LICENSE" 0644
