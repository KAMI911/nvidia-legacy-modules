...
NVDIR="$LIBDIR/nvidia/legacy-173xx"

install -d "$LIBDIR" "$NVDIR" "$DEST/usr/bin" "$DEST/usr/share/doc/nvidia-legacy-173xx-driver-libs" \
...
# --- license / docs ---
copy "LICENSE" "$DEST/usr/share/doc/nvidia-legacy-173xx-driver-libs/LICENSE" 0644
