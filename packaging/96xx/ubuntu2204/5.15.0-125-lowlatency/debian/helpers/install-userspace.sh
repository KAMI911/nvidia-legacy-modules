...
NVDIR="$LIBDIR/nvidia/legacy-96xx"

install -d "$LIBDIR" "$NVDIR" "$DEST/usr/bin" "$DEST/usr/share/doc/nvidia-legacy-96xx-driver-libs" \
...
# --- license / docs ---
copy "LICENSE" "$DEST/usr/share/doc/nvidia-legacy-96xx-driver-libs/LICENSE" 0644
