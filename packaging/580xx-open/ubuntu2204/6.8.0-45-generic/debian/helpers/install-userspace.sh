...
NVDIR="$LIBDIR/nvidia/legacy-580xx-open"

install -d "$LIBDIR" "$NVDIR" "$DEST/usr/bin" "$DEST/usr/share/doc/nvidia-legacy-580xx-open-driver-libs" \
...
# --- license / docs ---
copy "LICENSE" "$DEST/usr/share/doc/nvidia-legacy-580xx-open-driver-libs/LICENSE" 0644
